...
public class MatriculaServiceImpl implements IMatriculaService {
	...
	@Lookup
	public ProfesorMateria obtenerProfesorG() {
	...
	public void insertar(Matricula ma) {
		...
		System.out.println("DI desde un metodo M "+this.profesorMateria);
		System.out.println("DI desde un metodo G "+this.profesorGeneral);
